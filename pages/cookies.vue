  ...
  <div class="cookies row">
    <div class="cookies__text rte">
      ...
      <p>Cookies and similar technologies are very small text documents or pieces of code that often contain a unique
        ...
        for permission to store this file on your computer or mobile device and to access information. Information
        collected through cookies and similar technologies may include the date and time of the visit and how you use a
        particular website or mobile application.</p>
      <h2>Why do we use cookies?</h2>
      <p>Cookies ensure that you remain logged in during your visit to our online store, that all items remain in your
